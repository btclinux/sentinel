...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to anond "gobject list" output
    ...
    def anond_serialise(self):
        import anonlib
        return anonlib.SHIM_serialise_for_anond(self.serialise())
