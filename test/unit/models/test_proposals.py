...
def proposal():
    ...
    pobj = Proposal(
        ...
        payment_address="tAMeXXSZgZPaJKHMX114eyh62pMH9kvCczM",
        payment_amount=13
    )
...
def test_proposal_is_valid(proposal):
    ...
    proposal.payment_address = 'tAMeXXSZgZPaJKHMX114eyh62pMH9kvCczM'
    assert proposal.is_valid() is True
...
#         (go, subobj) = GovernanceObject.import_gobject_from_anond(anond, item)
