...
def invalid_anon_address(network='mainnet'):    
    return 'yYe8KwyaUu5YswSYmB3q3ryx8XTUu9y7Uj' if (network == 'testnet') else 'yYe8KwyaUu5YswSYmB3q3ryx8XTUu9y7Ui'
...
def test_hash_function():
    ...
    hex_hash = "%x" % anonlib.hashit(sb_data_hex)
